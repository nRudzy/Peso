...
@router.post(
    "/auth/register", response_model=BaseResponse, tags=[RouteTagsEnum.AUTHENTICATION]
)
...
@router.post(
    "/auth/login", response_model=TokenResponse, tags=[RouteTagsEnum.AUTHENTICATION]
)
...
@router.post(
    "/auth/refresh", response_model=TokenResponse, tags=[RouteTagsEnum.AUTHENTICATION]
)
...
@router.post(
    ...
    tags=[RouteTagsEnum.AUTHENTICATION],
)
