...
from app.utils.bmi_calculator import (
    calculate_bmi, get_bmi_category, get_healthy_weight_range,
    convert_weight, convert_height
)
...
class TestBMICalculator:
    ...
    def test_calculate_bmi_zero_weight(self):
        ...
        # Act & Assert
        with pytest.raises(ValueError, match="Weight and height must be positive values"):
