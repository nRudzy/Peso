...
class TestAuthService:
    ...
    def test_register_user_success(self):
        ...
        with patch.object(
            ...
            with patch.object(
                self.auth_service.user_service, "create_user", return_value=mock_user
            ):
                # Act
    ...
    def test_login_success(self):
        ...
        mock_user = Mock(
            id=1, email="test@example.com", email_verified=True, is_active=True
        )

        with patch.object(
            self.auth_service, "authenticate_user", return_value=mock_user
        ):
            with patch(
    ...
    def test_login_unverified_email(self):
        ...
        mock_user = Mock(
            id=1, email="test@example.com", email_verified=False, is_active=True
        )
        ...
        with patch.object(
            ...
            with patch(
                ...
                with patch(
                    ...
                    assert (
                        result is not None
                    )  # Login should still work even with unverified email
    ...
    def test_verify_email_success(self):
        ...
        with patch(
            ...
            return_value={"sub": "1", "type": "email_verification"},
        ):
            with patch.object(
                self.auth_service.user_service, "verify_email", return_value=True
            ):
                # Act
    ...
    def test_forgot_password_success(self):
        ...
        with patch.object(
            self.auth_service.user_service, "get_user_by_email", return_value=mock_user
        ):
            with patch.object(
    ...
    def test_reset_password_success(self):
        ...
        with patch(
            ...
            with patch.object(
                self.auth_service.user_service, "change_password", return_value=True
            ):
                # Act
