...
class TestWeightEntryService:
    ...
    def test_create_weight_entry_success(self):
        ...
        entry_data = WeightEntryCreate(
            weight=70.5, date=datetime.utcnow(), comment="Morning weight"
        )
        user_id = 1
        ...
        with patch.object(
            self.weight_service.repository, "create", return_value=mock_entry
        ):
            # Act
    ...
    def test_get_weight_entry_by_id_success(self):
        ...
        mock_entry = Mock(
            id=entry_id, weight=70.5, user_id=user_id, date=datetime.utcnow()
        )

        with patch.object(
            self.weight_service.repository,
            "get_by_user_and_id",
    ...
    def test_get_weight_entry_by_id_not_found(self):
        ...
        with patch.object(
            self.weight_service.repository, "get_by_user_and_id", return_value=None
        ):
            # Act
            result = self.weight_service.get_weight_entry_by_id(entry_id, user_id)
    ...
    def test_update_weight_entry_success(self):
        ...
        entry_id = 1
        user_id = 1
        update_data = WeightEntryUpdate(weight=71.0, comment="Updated weight")
        ...
        with patch.object(
            self.weight_service, "get_weight_entry_by_id", return_value=mock_entry
        ):
            with patch.object(
                self.weight_service.repository, "update", return_value=mock_entry
            ):
                # Act
                result = self.weight_service.update_weight_entry(
    ...
    def test_update_weight_entry_not_found(self):
        ...
        with patch.object(
            self.weight_service, "get_weight_entry_by_id", return_value=None
        ):
            # Act & Assert
    ...
    def test_delete_weight_entry_success(self):
        ...
        with patch.object(
            self.weight_service.repository, "delete_by_user_and_id", return_value=True
        ):
            # Act
    ...
    def test_delete_weight_entry_not_found(self):
        ...
        with patch.object(
            self.weight_service.repository, "delete_by_user_and_id", return_value=False
        ):
            # Act
            result = self.weight_service.delete_weight_entry(entry_id, user_id)
    ...
    def test_get_user_weight_entries_success(self):
        ...
        with patch.object(
            self.weight_service.repository, "get_by_user_id", return_value=mock_entries
        ):
            # Act
    ...
    def test_get_latest_weight_entry_success(self):
        ...
        mock_entry = Mock(id=1, weight=70.5, user_id=user_id, date=datetime.utcnow())
    ...
    def test_get_latest_weight_entry_not_found(self):
        ...
        with patch.object(
            self.weight_service.repository, "get_latest_by_user", return_value=None
        ):
            # Act
            result = self.weight_service.get_latest_weight_entry(user_id)
    ...
    def test_get_weight_statistics_success(self):
        ...
        with patch.object(
            self.weight_service, "get_user_weight_entries", return_value=mock_entries
        ):
            # Act
    ...
    def test_get_weight_statistics_no_entries(self):
        ...
        with patch.object(
            self.weight_service, "get_user_weight_entries", return_value=[]
        ):
            # Act
            result = self.weight_service.get_weight_statistics(user_id)
    ...
    def test_get_weight_progress_success(self):
        ...
        with patch.object(
            self.weight_service,
            "get_weight_entries_by_date_range",
    ...
    def test_get_weight_progress_no_entries(self):
        ...
        with patch.object(
            self.weight_service, "get_weight_entries_by_date_range", return_value=[]
        ):
            # Act
            result = self.weight_service.get_weight_progress(user_id, days)
...
class TestWeightEntryAPI:
    ...
    def test_create_weight_entry_endpoint_success(self):
        ...
        with patch(
            "app.routes.weight_entries.get_current_verified_user",
            ...
            with patch("app.routes.weight_entries.WeightEntryService") as mock_service:
                ...
                mock_service_instance.create_weight_entry.return_value = Mock(
                    id=1, weight=70.5, user_id=1, date=datetime.utcnow()
                )
    ...
    def test_get_weight_entries_endpoint_success(self):
        ...
        mock_entries = [
            ...
            Mock(
                id=2, weight=70.2, user_id=1, date=datetime.utcnow() - timedelta(days=1)
            ),
        ]
        ...
        with patch(
            ...
            with patch("app.routes.weight_entries.WeightEntryService") as mock_service:
                mock_service_instance = Mock()
                mock_service_instance.get_user_weight_entries.return_value = (
                    mock_entries
                )
                mock_service.return_value = mock_service_instance
    ...
    def test_get_latest_weight_entry_endpoint_success(self):
        ...
        mock_entry = Mock(id=1, weight=70.5, user_id=1, date=datetime.utcnow())
    ...
    def test_get_weight_statistics_endpoint_success(self):
        ...
        with patch(
            ...
            with patch("app.routes.weight_entries.WeightEntryService") as mock_service:
                mock_service_instance = Mock()
                mock_service_instance.get_weight_statistics.return_value = (
                    mock_statistics
                )
                mock_service.return_value = mock_service_instance
    ...
    def test_update_weight_entry_endpoint_success(self):
        ...
        # Arrange
        entry_id = 1
        update_data = {"weight": 71.0, "comment": "Updated weight"}

        mock_user = Mock(id=1, email="test@example.com", email_verified=True)

        mock_entry = Mock(id=entry_id, weight=71.0, user_id=1, date=datetime.utcnow())
        ...
        with patch(
            ...
            with patch("app.routes.weight_entries.WeightEntryService") as mock_service:
                ...
                response = self.client.put(
                    f"/api/v1/weight-entries/{entry_id}", json=update_data
                )
